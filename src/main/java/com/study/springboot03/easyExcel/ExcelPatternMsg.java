...
public class ExcelPatternMsg {
     ...
     */
    public static final String DATE_TIME1 = "(\\d{2}|\\d{4})(?:\\-)?([0]{1}\\d{1}|[1]{1}[0-2]{1})(?:\\-)?" +
            "([0-2]{1}\\d{1}|[3]{1}[0-1]{1})(?:\\s)?([0-1]{1}\\d{1}|[2]{1}[0-3]{1})(?::)?([0-5]{1}\\d{1})(?::)?([0-5]{1}\\d{1})";
    ...
    public static void main(String[] args) {
        System.out.println(Pattern.matches(DATE_TIME1, "1970-00-00 00:00:00"));
    }
}
